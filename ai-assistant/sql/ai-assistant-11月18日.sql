...
COMMENT ON COLUMN "public"."t_course"."user_id" IS '上传者ID';

-- ----------------------------
-- Table structure for t_course_video
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_course_video";
CREATE TABLE "public"."t_course_video" (
  "video_id" int8 NOT NULL,
  "course_id" int8 NOT NULL,
  "user_id" int8 NOT NULL,
  "belong_passage" varchar(255) COLLATE "pg_catalog"."default",
  "video_name" varchar(255) COLLATE "pg_catalog"."default",
  "video_url" varchar(255) COLLATE "pg_catalog"."default",
  "video_description" varchar(255) COLLATE "pg_catalog"."default",
  "prestore_field2" varchar(255) COLLATE "pg_catalog"."default",
  "prestore_field3" varchar(255) COLLATE "pg_catalog"."default",
  "prestore_field4" varchar(255) COLLATE "pg_catalog"."default",
  "prestore_field5" varchar(255) COLLATE "pg_catalog"."default",
  "create_time" timestamp(6),
  "update_time" timestamp(6)
)
;
COMMENT ON COLUMN "public"."t_course_video"."video_id" IS '视频ID';
COMMENT ON COLUMN "public"."t_course_video"."course_id" IS '所属课程ID';
COMMENT ON COLUMN "public"."t_course_video"."user_id" IS '上传人的ID';
COMMENT ON COLUMN "public"."t_course_video"."belong_passage" IS '所属章节';
COMMENT ON COLUMN "public"."t_course_video"."video_name" IS '视频名称';
COMMENT ON COLUMN "public"."t_course_video"."video_url" IS '保存路径';
COMMENT ON COLUMN "public"."t_course_video"."video_description" IS '视频描述';
COMMENT ON COLUMN "public"."t_course_video"."prestore_field2" IS '预存字段2';
COMMENT ON COLUMN "public"."t_course_video"."prestore_field3" IS '预存字段3';
COMMENT ON COLUMN "public"."t_course_video"."prestore_field4" IS '预存字段4';
COMMENT ON COLUMN "public"."t_course_video"."prestore_field5" IS '预存字段5';
COMMENT ON COLUMN "public"."t_course_video"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."t_course_video"."update_time" IS '修改时间';
...
SELECT setval('"public"."t_category_category_id_seq"', 5, true);
...
-- ----------------------------
-- Primary Key structure for table t_course_video
-- ----------------------------
ALTER TABLE "public"."t_course_video" ADD CONSTRAINT "t_course_video_pkey" PRIMARY KEY ("video_id");
