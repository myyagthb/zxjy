...
import edu.hut.aiassistant.config.TengXunSmsConfig;
 ...
 */
@Component
public class TengXunSendSmsUtils {


    @Autowired
    private TengXunSmsConfig smsConfig;
     ...
     */
    public Integer sendSMSToMobile(String mobile)
    {
        try {
            ...
            String sdkAppId = String.valueOf(smsConfig.getSdkAppId());
            ...
            String templateId = String.valueOf(smsConfig.getTemplateId());
            ...
            String[] templateParamSet = {String.valueOf(code),String.valueOf(minute)};
     ...
     * @param mobile 接收短信的电话号码
     */
    public Integer sendSMSToMobile(String mobile,Integer minute)
    {
        try {
            // 实例化一个认证对象，入参需要传入腾讯云账户 SecretId，SecretKey。
            // 为了保护密钥安全，建议将密钥设置在环境变量中或者配置文件中，请参考凭证管理 https://github.com/TencentCloud/tencentcloud-sdk-java?tab=readme-ov-file#%E5%87%AD%E8%AF%81%E7%AE%A1%E7%90%86。
